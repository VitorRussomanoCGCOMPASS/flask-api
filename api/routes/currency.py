...
from api.request_schemas.currency import (CurrencyPeriodQuerySchema,
...
def get_currency_values_date():
    ...
    if date:
        ...
        result = CurrencyValues.query.filter_by(currency_id = currency_id,date=date).first_or_404()
